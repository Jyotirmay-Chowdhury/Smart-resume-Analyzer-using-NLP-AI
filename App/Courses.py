...
devops_course = [['IBM DevOps and Software Engineering Professional Certificate','https://www.coursera.org/professional-certificates/devops-and-software-engineering'],
                 ['DevOps Beginners to Advanced with Projects - 2023','https://www.udemy.com/course/decodingdevops/'],
                 ['DevOps Tutorial for Beginners | Learn DevOps in 7 Hours - Full Course for Free','https://www.youtube.com/watch?v=hQcFE0RD0cQ'],
                 ['DevOps Full Course by Simplilearn for Free','https://www.youtube.com/watch?v=5KtRF4NuUWE'],
                 ['DevOps In-Depth Tutorial for 2022 for Free','https://www.youtube.com/watch?v=rxMANm_C27o'],
                 ['AWS Foundation Course for free','https://intellipaat.com/academy/course/aws-free-course/'],
                 ['DevOps Foundation Course for free','https://intellipaat.com/academy/course/devops-free-course/'],
                 ['Microsoft Azure Administration Foundation Course for free','https://intellipaat.com/academy/course/microsoft-azure-admin-az-103-az-100-and-az-101-free-course/'],
                 ['DevOps Course with DevOps Training and DevOps Tools Traning-Intellipaat for free','https://www.youtube.com/watch?v=YzwD02ImKY4'],
                 ['AWS Certified DevOps Engineer - Professional','https://explore.skillbuilder.aws/learn/course/external/view/elearning/74/exam-readiness-aws-certified-devops-engineer-professional?lado=tile&tile=dt']]
